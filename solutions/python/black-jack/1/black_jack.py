...
def higher_card(card_one, card_two):
    ...
    if card1==card2:
        ...
        return card_one if card1>card2 else card_two
...
def value_of_ace(card_one, card_two):
    ...
    card1=value_of_card(card_one) if card_one!="A" else 11
    card2=value_of_card(card_two) if card_two!="A" else 11

    return 11 if card1 + card2+11<=21 else 1
